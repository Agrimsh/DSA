class Solution {
    public boolean exist(char[][] board, String word) {
        ...
        for(int i=0;i<n;i++){//loops for visiting at each block of matrix
            for(int j=0;j<m;j++){
    ...
    public boolean search(char[][] board,String word,int i,int j, int idx){
        ...
        boolean found=search(board,word,i+1,j,idx+1) || search(board,word,i-1,j,idx+1) || search(board,word,i,j+1,idx+1)
